...
class Fragment$historyOrderItem$edges$node$service {
  ...
  factory Fragment$historyOrderItem$edges$node$service.fromJson(
    ...
    return Fragment$historyOrderItem$edges$node$service(
      media: Fragment$historyOrderItem$edges$node$service$media.fromJson(
          (l$media as Map<String, dynamic>)),
      name: (l$name as String),
    );
  }

  final Fragment$historyOrderItem$edges$node$service$media media;
...
abstract class CopyWith$Fragment$historyOrderItem$edges$node$service<TRes> {
  ...
  TRes call({
    Fragment$historyOrderItem$edges$node$service$media? media,
    String? name,
  });
  CopyWith$Fragment$historyOrderItem$edges$node$service$media<TRes> get media;
}
...
class _CopyWithImpl$Fragment$historyOrderItem$edges$node$service<TRes>
  ...
  TRes call({
    ...
    Object? name = _undefined,
      ...
      _then(Fragment$historyOrderItem$edges$node$service(
        media: media == _undefined || media == null
            ? _instance.media
            : (media as Fragment$historyOrderItem$edges$node$service$media),
        name: name == _undefined || name == null
            ? _instance.name
            : (name as String),
      ));
  CopyWith$Fragment$historyOrderItem$edges$node$service$media<TRes> get media {
    final local$media = _instance.media;
    return CopyWith$Fragment$historyOrderItem$edges$node$service$media(
        local$media, (e) => call(media: e));
  }
}
...
class _CopyWithStubImpl$Fragment$historyOrderItem$edges$node$service<TRes>
  ...
  call({
    ...
    String? name,
      ...
      _res;
  CopyWith$Fragment$historyOrderItem$edges$node$service$media<TRes> get media =>
      CopyWith$Fragment$historyOrderItem$edges$node$service$media.stub(_res);
}

class Fragment$historyOrderItem$edges$node$service$media {
  Fragment$historyOrderItem$edges$node$service$media({required this.address});

  factory Fragment$historyOrderItem$edges$node$service$media.fromJson(
      Map<String, dynamic> json) {
    final l$address = json['address'];
    return Fragment$historyOrderItem$edges$node$service$media(
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Fragment$historyOrderItem$edges$node$service$media) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$address = address;
...
extension UtilityExtension$Fragment$historyOrderItem$edges$node$service$media
    on Fragment$historyOrderItem$edges$node$service$media {
  CopyWith$Fragment$historyOrderItem$edges$node$service$media<
          Fragment$historyOrderItem$edges$node$service$media>
      get copyWith =>
          CopyWith$Fragment$historyOrderItem$edges$node$service$media(
            this,
            (i) => i,
...
abstract class CopyWith$Fragment$historyOrderItem$edges$node$service$media<
    TRes> {
  factory CopyWith$Fragment$historyOrderItem$edges$node$service$media(
    Fragment$historyOrderItem$edges$node$service$media instance,
    TRes Function(Fragment$historyOrderItem$edges$node$service$media) then,
  ) = _CopyWithImpl$Fragment$historyOrderItem$edges$node$service$media;

  factory CopyWith$Fragment$historyOrderItem$edges$node$service$media.stub(
          TRes res) =
      _CopyWithStubImpl$Fragment$historyOrderItem$edges$node$service$media;

  TRes call({String? address});
}

class _CopyWithImpl$Fragment$historyOrderItem$edges$node$service$media<TRes>
    implements
        CopyWith$Fragment$historyOrderItem$edges$node$service$media<TRes> {
  _CopyWithImpl$Fragment$historyOrderItem$edges$node$service$media(
    this._instance,
    this._then,
  );

  final Fragment$historyOrderItem$edges$node$service$media _instance;

  final TRes Function(Fragment$historyOrderItem$edges$node$service$media) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? address = _undefined}) =>
      _then(Fragment$historyOrderItem$edges$node$service$media(
          address: address == _undefined || address == null
              ? _instance.address
              : (address as String)));
}

class _CopyWithStubImpl$Fragment$historyOrderItem$edges$node$service$media<TRes>
    implements
        CopyWith$Fragment$historyOrderItem$edges$node$service$media<TRes> {
  _CopyWithStubImpl$Fragment$historyOrderItem$edges$node$service$media(
      this._res);
