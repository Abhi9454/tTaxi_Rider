        ...
        return Scaffold(
            body: Query(
                ...
                builder: (QueryResult result,
                  ...
                  // runLastSeenMutation(
                  //     UpdateLastSeenMessagesAtArguments(requestId: order.id)
                  //         .toJson());
                      ...
                      builder: (QueryResult subscriptionResult) {
                        ...
                        return Mutation(
                            options: MutationOptions(
                                ...
                                fetchPolicy: FetchPolicy.noCache),
                            builder: (runSendMessageMutation,
                                          ...
                                          child: Row(
                                            children: [
                                              Mutation(
                                                  options: MutationOptions(
                                                      document:
                                                          UPDATE_LAST_SEEN_MESSAGES_AT_MUTATION_DOCUMENT),
