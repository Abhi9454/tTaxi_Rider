...
class Query$GetCurrentOrder {
  ...
  final Fragment$Point? getCurrentOrderDriverLocation;
...
abstract class CopyWith$Query$GetCurrentOrder<TRes> {
  ...
  TRes call({
    ...
    Fragment$Point? getCurrentOrderDriverLocation,
  });
  CopyWith$Query$GetCurrentOrder$rider<TRes> get rider;
  CopyWith$Fragment$Point<TRes> get getCurrentOrderDriverLocation;
}
...
class _CopyWithImpl$Query$GetCurrentOrder<TRes>
      ...
      _then(Query$GetCurrentOrder(
        ...
        getCurrentOrderDriverLocation:
            getCurrentOrderDriverLocation == _undefined
                ...
                : (getCurrentOrderDriverLocation as Fragment$Point?),
      ));
  CopyWith$Query$GetCurrentOrder$rider<TRes> get rider {
  ...
  CopyWith$Fragment$Point<TRes> get getCurrentOrderDriverLocation {
    ...
    return local$getCurrentOrderDriverLocation == null
        ...
        : CopyWith$Fragment$Point(local$getCurrentOrderDriverLocation,
...
class Query$GetCurrentOrder$rider {
  ...
  final List<Fragment$CurrentOrder> orders;
...
abstract class CopyWith$Query$GetCurrentOrder$rider<TRes> {
  ...
  TRes call({
    ...
    List<Fragment$CurrentOrder>? orders,
...
class _CopyWithImpl$Query$GetCurrentOrder$rider<TRes>
    ...
    Object? bookedOrders = _undefined,
      ...
      _then(Query$GetCurrentOrder$rider(
        ...
        orders: orders == _undefined || orders == null
            ? _instance.orders
            : (orders as List<Fragment$CurrentOrder>),
  ...
  TRes orders(
      ...
      call(
          orders:
              _fn(_instance.orders.map((e) => CopyWith$Fragment$CurrentOrder(
                    e,
                    (i) => i,
                  ))).toList());
  TRes bookedOrders(
...
class Subscription$UpdatedOrder$orderUpdated {
  ...
  factory Subscription$UpdatedOrder$orderUpdated.fromJson(
    ...
    return Subscription$UpdatedOrder$orderUpdated(
      ...
      points: (l$points as List<dynamic>)
          .map((e) => Subscription$UpdatedOrder$orderUpdated$points.fromJson(
              (e as Map<String, dynamic>)))
          .toList(),
  ...
  final List<Subscription$UpdatedOrder$orderUpdated$points> points;
...
abstract class CopyWith$Subscription$UpdatedOrder$orderUpdated<TRes> {
  ...
  TRes call({
    ...
    List<Subscription$UpdatedOrder$orderUpdated$points>? points,
  ...
  TRes conversations(
      Iterable<Subscription$UpdatedOrder$orderUpdated$conversations> Function(
          ...
          _fn);
  TRes points(
      Iterable<Subscription$UpdatedOrder$orderUpdated$points> Function(
              Iterable<
                  CopyWith$Subscription$UpdatedOrder$orderUpdated$points<
                      Subscription$UpdatedOrder$orderUpdated$points>>)
          _fn);
    ...
    Object? service = _undefined,
      ...
      _then(Subscription$UpdatedOrder$orderUpdated(
        ...
        points: points == _undefined || points == null
            ? _instance.points
            : (points as List<Subscription$UpdatedOrder$orderUpdated$points>),
  ...
  TRes points(
      ...
      call(
          points: _fn(_instance.points.map(
              (e) => CopyWith$Subscription$UpdatedOrder$orderUpdated$points(
                    e,
                    (i) => i,
                  ))).toList());
  CopyWith$Subscription$UpdatedOrder$orderUpdated$driver<TRes> get driver {
...
class Subscription$UpdatedOrder$orderUpdated$points {
  Subscription$UpdatedOrder$orderUpdated$points({
    required this.lat,
    required this.lng,
  });

  factory Subscription$UpdatedOrder$orderUpdated$points.fromJson(
      Map<String, dynamic> json) {
    final l$lat = json['lat'];
    final l$lng = json['lng'];
    return Subscription$UpdatedOrder$orderUpdated$points(
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Subscription$UpdatedOrder$orderUpdated$points) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$lat = lat;
...
extension UtilityExtension$Subscription$UpdatedOrder$orderUpdated$points
    on Subscription$UpdatedOrder$orderUpdated$points {
  CopyWith$Subscription$UpdatedOrder$orderUpdated$points<
          Subscription$UpdatedOrder$orderUpdated$points>
      get copyWith => CopyWith$Subscription$UpdatedOrder$orderUpdated$points(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Subscription$UpdatedOrder$orderUpdated$points<TRes> {
  factory CopyWith$Subscription$UpdatedOrder$orderUpdated$points(
    Subscription$UpdatedOrder$orderUpdated$points instance,
    TRes Function(Subscription$UpdatedOrder$orderUpdated$points) then,
  ) = _CopyWithImpl$Subscription$UpdatedOrder$orderUpdated$points;

  factory CopyWith$Subscription$UpdatedOrder$orderUpdated$points.stub(
          TRes res) =
      _CopyWithStubImpl$Subscription$UpdatedOrder$orderUpdated$points;
...
class _CopyWithImpl$Subscription$UpdatedOrder$orderUpdated$points<TRes>
    implements CopyWith$Subscription$UpdatedOrder$orderUpdated$points<TRes> {
  _CopyWithImpl$Subscription$UpdatedOrder$orderUpdated$points(
    this._instance,
    this._then,
  );

  final Subscription$UpdatedOrder$orderUpdated$points _instance;

  final TRes Function(Subscription$UpdatedOrder$orderUpdated$points) _then;
  ...
  TRes call({
    ...
    Object? lng = _undefined,
      ...
      _then(Subscription$UpdatedOrder$orderUpdated$points(
        lat: lat == _undefined || lat == null ? _instance.lat : (lat as double),
        lng: lng == _undefined || lng == null ? _instance.lng : (lng as double),
      ));
}

class _CopyWithStubImpl$Subscription$UpdatedOrder$orderUpdated$points<TRes>
    implements CopyWith$Subscription$UpdatedOrder$orderUpdated$points<TRes> {
  _CopyWithStubImpl$Subscription$UpdatedOrder$orderUpdated$points(this._res);
...
graphql_flutter
    .QueryHookResult<Query$GetReviewParameters> useQuery$GetReviewParameters(
        [Options$Query$GetReviewParameters? options]) =>
    graphql_flutter.useQuery(options ?? Options$Query$GetReviewParameters());
graphql.ObservableQuery<Query$GetReviewParameters>
...
class Query$GetFare$getFare$directions {
  Query$GetFare$getFare$directions({
    required this.lat,
    required this.lng,
  });
